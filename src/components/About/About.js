...
const About = () => {
    return (
        <div className="bg-cover bg-[url('https://st.depositphotos.com/1003593/3947/i/450/depositphotos_39479909-stock-photo-about-us-blue-marker.jpg')] p-6 bg-gray-100 text-gray-800 h-[84vh]">
